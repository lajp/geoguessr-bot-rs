                ...
                match command.data.options[0].options[0].name.as_str() {
                    ...
                    "battle-royale" => {
                        ...
                        if create {
                            ...
                            response = match start_battleroyale(
                                gametype.as_str().unwrap(),
                                lobby.as_str().unwrap(),
                                moving.as_str().unwrap(),
                                panning.as_str().unwrap(),
                                zooming.as_str().unwrap(),
                                fiftyfifty.as_str().unwrap(),
                                spy.as_str().unwrap(),
                            )
                            .await
                            {
                                Ok(_) => "Starting game...".to_string(),
                                Err(_) => "Ran into an error while starting game".to_string(),
                            };
                        }
                    }
                    _ => response = "Unknown command! Skipping...".to_string(),
                }
                if response == *"ok" {
...
pub async fn create_slash_commands(ctx: &Context) {
    ApplicationCommand::set_global_application_commands(&ctx.http, |commands| {
        commands.create_application_command(|command| {
            command
                .name("geo")
                .description("Get GeoGuessr challenge link")
                            ...
                            subopt
                                ...
                                .create_sub_option(|subopt3| {
                                    subopt3
                                        ...
                                        .add_string_choice(
                                            "The 5050-powerup is not available",
                                            "false",
                                        )
                                })
                                .create_sub_option(|subopt3| {
                                    subopt3
                                        ...
                                        .add_string_choice(
                                            "The Spy-powerup is not available",
                                            "false",
                                        )
                                })
                        })
